...
# Usage
data_directory = 'Patient-Exchange-ML-TF/data/filtered_blocks/'  # Replace with your CSV directory path
output_directory = 'Patient-Exchange-ML-TF/data/filtered_blocks_padded/'  # Replace with your desired output directory
